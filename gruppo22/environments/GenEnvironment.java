...
public class GenEnvironment<T> implements Environment<T> {
	...
	/*
	 * looks up id starting from the innermost scope; throws EnvironmentException if
	 * id could not be found in any scope
	 */
	...
	/*
	 * updates the most nested scope by associating id with payload; id is not
	 * allowed to be already defined, id and payload must be non-null
	 */
	...
	/*
	 * updates the payload of the most enclosed id, throws an exception if no id can
	 * be found in the scope chain. Only used for the dynamic semantics
	 */
